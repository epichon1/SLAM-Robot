...
#   WS=~/other_ws ./record_demo.sh
DIR=$(cd "$(dirname "$0")" && pwd)
DISP=:9
SECS=${SECS:-85}

# The colcon workspace this repository was built in.  Assumes the usual
# layout, <workspace>/<this repo>/vertex_media; override with WS if not.
WS=${WS:-$(cd "$DIR/../.." && pwd)}
